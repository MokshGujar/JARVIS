...
DEFAULT_CONFIG: dict[str, dict[str, Any]] = {
    ...
    "summary": {
        ...
        "parakeet_domain_correction_enabled": True,
            "parakeet_domain_corrections": "Jarris=Jarvis|Javi=Jarvis|Javis=Jarvis|Jaris=Jarvis|Javas=Jarvis|Jervis=Jarvis|Javier=Jarvis|Jawis=Jarvis|Jais=Jarvis|Jarwis=Jarvis|Jarvish=Jarvis",
    ...
    "tts": {
        ...
        "thinking_audio_mode": "smart",
        "thinking_audio_skip_for_fast_semantic": True,
        "thinking_audio_skip_for_empty_transcript": True,
        "thinking_audio_skip_for_clarification": True,
        "thinking_audio_skip_for_confirmation": True,
        "thinking_audio_skip_for_greeting": True,
        "thinking_audio_one_per_turn": True,
        "thinking_audio_allow_finish_before_tts": True,
        "thinking_audio_max_duration_ms": 1800,
        "thinking_audio_fade_out_ms": 120,
        "thinking_audio_min_delay_ms": 400,
        "voice_audio_single_queue": True,
        "voice_audio_allow_overlap": False,
        "tts_cancel_stale_turns": True,
        "stt_empty_transcript_play_tts": False,
        "stt_empty_transcript_reset_mic": True,
        "voice_barge_in_enabled": True,
        "voice_interrupt_on_new_speech": True,
        "voice_auto_restart_mic_after_tts": True,
        "voice_interrupt_debounce_ms": 800,
        "voice_do_not_interrupt_on_tts_end": True,
    },
    "features": {
