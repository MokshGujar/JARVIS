...
TOOL_INVENTORY: tuple[ToolInventoryRecord, ...] = (
    ...
    _record("app", "app", "Open, focus, and close local applications.", supported_intents=("app", "app_open", "app_close", "app_focus"), supported_actions=("open", "focus", "close"), safety_level="HIGH", current_status="live_routed", target_connector="LocalAppConnector", planned_phase="current", test_requirements=("app_launcher_mocks",)),
    _record("browser", "browser", "Browser search and navigation automation.", supported_intents=("browser", "browser_search", "browser_open_url", "browser_open_site"), supported_actions=("search", "open_url", "open_site", "youtube_search", "youtube_play", "navigation", "form_input", "form_submit"), safety_level="HIGH", current_status="live_routed", target_connector="BrowserConnector", planned_phase="current", test_requirements=("browser_mocks", "no_real_form_submit")),
    _record("system", "system", "Local system controls.", supported_intents=("system", "volume_up", "volume_down", "mute_volume", "screenshot", "show_desktop", "window_control", "lock_system", "shutdown_system", "restart_system"), supported_actions=("volume_up", "volume_down", "mute_volume", "screenshot", "show_desktop", "window_control", "safe_system_info", "lock_system", "shutdown_system", "restart_system"), safety_level="CRITICAL", current_status="live_routed", target_adapter="local_system_adapter", planned_phase="current", test_requirements=("system_mocks", "no_real_power_actions")),
    _record("whatsapp", "communication", "WhatsApp Desktop/Web messaging and calls.", supported_intents=("whatsapp", "communication"), supported_actions=("open", "open_chat", "search_contact", "prepare_message", "prepare_call", "send_message", "start_voice_call", "start_video_call", "end_call"), safety_level="HIGH", current_status="live_routed", target_connector="WhatsAppDesktopConnector", action_safety=(("open", "LOW"), ("open_chat", "HIGH"), ("search_contact", "LOW"), ("prepare_message", "LOW"), ("prepare_call", "LOW"), ("send_message", "HIGH"), ("start_voice_call", "HIGH"), ("start_video_call", "HIGH"), ("end_call", "LOW")), protected_actions=("open_chat", "send_message", "start_voice_call", "start_video_call"), planned_phase="communication_extraction", test_requirements=("no_real_send", "no_real_calls", "confirmation_required")),
    _record("gmail", "communication", "Gmail email search, read, draft, and send shell.", supported_intents=("gmail", "email", "mail", "communication"), supported_actions=("prepare_email", "get_unread_count", "search_emails", "read_latest_email", "draft_email", "send_email", "reply_email", "list_drafts"), safety_level="HIGH", current_status="live_routed", target_connector="GmailConnector", action_safety=(("prepare_email", "LOW"), ("get_unread_count", "LOW"), ("search_emails", "MEDIUM"), ("read_latest_email", "MEDIUM"), ("draft_email", "MEDIUM"), ("send_email", "HIGH"), ("reply_email", "HIGH")), protected_actions=("send_email", "reply_email"), planned_phase="direct_communication", test_requirements=("connector_mocks", "no_real_email")),
