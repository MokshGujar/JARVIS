...
TOOL_INVENTORY: tuple[ToolInventoryRecord, ...] = (
    ...
    _record("system", "system", "Local system controls.", supported_intents=("system", "volume_up", "volume_down", "mute_volume", "screenshot", "show_desktop", "window_control", "lock_system", "shutdown_system", "restart_system"), supported_actions=("volume_up", "volume_down", "mute_volume", "screenshot", "show_desktop", "window_control", "safe_system_info", "lock_system", "shutdown_system", "restart_system"), safety_level="CRITICAL", current_status="live_routed", legacy_delegate="AutomationService._execute_system_command_legacy", planned_phase="current", test_requirements=("system_mocks", "no_real_power_actions")),
    _record("whatsapp", "communication", "WhatsApp Desktop/Web messaging and calls.", supported_intents=("whatsapp", "communication"), supported_actions=("open", "search_contact", "prepare_message", "prepare_call", "send_message", "start_voice_call", "start_video_call", "end_call"), safety_level="HIGH", current_status="live_routed", legacy_delegate="AutomationService._execute_whatsapp_command_legacy", target_connector="WhatsAppDesktopConnector", action_safety=(("open", "LOW"), ("search_contact", "LOW"), ("prepare_message", "LOW"), ("prepare_call", "LOW"), ("send_message", "HIGH"), ("start_voice_call", "HIGH"), ("start_video_call", "HIGH"), ("end_call", "LOW")), protected_actions=("send_message", "start_voice_call", "start_video_call"), planned_phase="communication_extraction", test_requirements=("no_real_send", "no_real_calls", "confirmation_required")),
