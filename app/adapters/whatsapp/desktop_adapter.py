...
class WhatsAppDesktopResult:
    ...
    def as_dict(self) -> dict[str, Any]:
        return {"success": self.success, "status": self.status, "message": self.message, "details": self.details or {}}


class WhatsAppDesktopAdapter:
    """Adapter boundary for WhatsApp Desktop UI automation."""
